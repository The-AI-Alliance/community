...
* [License: Creative Commons BY 4.0](https://github.com/The-AI-Alliance/community/blob/main/LICENSE.CC-BY-4.0) is our recommended open-source license for _documentation_, such as the _microsites_ for the projects.
* [License: CDLA 2.0](https://github.com/The-AI-Alliance/community/blob/main/LICENSE.CDLA-2.0) is our recommended open-source license for _data_ assets.
* [Governance](https://thealliance.ai/governance) describes the AI Alliance governance principles and processes.
